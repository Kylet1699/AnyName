...
var special_attack_damage = 25.0
var special_attack_cd_duration = 2.0
...
func _process(delta):
	...
	if special_attack_cd_timer <= 0:
		next_attack = special_attack_damage
	else:
		next_attack = attack_damage
...
func _on_body_entered(body):
	if (body.is_in_group("characters") or body.is_in_group("projectiles")):
		...
		if next_attack == special_attack_damage:
